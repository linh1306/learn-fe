...
export const apiResetPassword = (
    bodyResetPasswordDto: BodyType<BodyResetPasswordDto>,
 signal?: AbortSignal
) => {
      ...
      headers: {'Content-Type': 'application/json', },
      data: bodyResetPasswordDto, signal
    },
      );
    }
...
export const getApiResetPasswordMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof apiResetPassword>>, TError,{data: BodyType<BodyResetPasswordDto>}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof apiResetPassword>>, TError,{data: BodyType<BodyResetPasswordDto>}, TContext> => {

const mutationKey = ['apiResetPassword'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof apiResetPassword>>, {data: BodyType<BodyResetPasswordDto>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ApiResetPasswordMutationBody = BodyType<BodyResetPasswordDto>
    export type ApiResetPasswordMutationError = ErrorType<unknown>

    /**
 * @summary Cấp lại mật khẩu
 */
export const useApiResetPassword = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof apiResetPassword>>, TError,{data: BodyType<BodyResetPasswordDto>}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof apiResetPassword>>,
        TError,
        {data: BodyType<BodyResetPasswordDto>},
        TContext
      > => {
