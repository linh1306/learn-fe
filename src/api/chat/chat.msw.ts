...
export const getApiChatResponseMock = (overrideResponse: Partial< ResChatWithGeminiDto > = {}): ResChatWithGeminiDto => ({fixed: faker.string.alpha(20), list: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({raw: faker.string.alpha(20), word: faker.string.alpha(20), phonetic: faker.string.alpha(20), meaning: faker.string.alpha(20), exEn: faker.string.alpha(20), exVi: faker.string.alpha(20)})), explain: faker.string.alpha(20), reply: faker.string.alpha(20), vi: faker.string.alpha(20), ...overrideResponse})
